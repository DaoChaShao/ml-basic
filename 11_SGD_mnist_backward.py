...
# -*- Coding: UTF-8 -*-
# @Time     :   2025/10/13 14:10
# @Author   :   Shawn
# @Version  :   Version 0.1.0
# @File     :   11_SGD_mnist_backward.py
# @Desc     :   
...
def main() -> None:
    ...
    # Set the model
    model = Full2LayersNN(input_size=x_train.shape[1], hidden_units=64, output_size=y_train.shape[1])
    ...
    for i in range(epochs):
        ...
        for j in range(0, x_train.shape[0], batch_size):
            ...
            grads = model.backward(x_train_batch, y_train_batch)
            ...
            Batch 469.0/469.0
            - Loss: 0.4274 - Train Acc: 0.8721 - Test Acc: 0.8771
            """
